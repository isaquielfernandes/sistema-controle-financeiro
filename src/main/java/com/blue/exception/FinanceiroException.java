...
@ControllerAdvice
public class FinanceiroException extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
		...
		String msgUsuario = messageSource.getMessage("memsagem.invalida",  null, LocaleContextHolder.getLocale());
