...
import com.blue.service.PessoaService;
...
public class PessoaController {
	...
	public ResponseEntity<Pessoa> criar(@Valid @RequestBody Pessoa entity, HttpServletResponse response){
		...
		Pessoa pessoaSalva = pessoaService.salvar(entity);
	...
	public void atualizarPropriesadeAtivo(@PathVariable Long codigo, @RequestBody Boolean ativo) {
