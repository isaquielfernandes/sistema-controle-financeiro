...
-- INSERT INTO usuario (codigo, nome, email, senha) values (1, 'Administrador', 'adaumir.costa@itbam.org.br', '$2a$10$X607ZPhQ4EgGNaYKt3n4SONjIv9zc.VMWdEuhCuba7oLAL5IvcL5.');
-- INSERT INTO usuario (codigo, nome, email, senha) values (2, 'Maria Silva', 'adaumir.costa@itbam.org.br', '$2a$10$Zc3w6HyuPOPXamaMhh.PQOXvDnEsadztbfi6/RyZWJDzimE8WQjaq');
INSERT INTO usuario (codigo, nome, email, senha) values (3, 'Adaumir Costa', 'adaumir.costa@itbam.org.br', '$2a$10$X607ZPhQ4EgGNaYKt3n4SONjIv9zc.VMWdEuhCuba7oLAL5IvcL5.');
